...
** Tab Bar (Workspaces)
;; tab-bar-mode es built-in desde Emacs 27. Cada tab mantiene su propio
;; layout de ventanas y buffers. Los faces usan la paleta Catppuccin Mocha
;; definida en la sección Colores.
#+begin_src emacs-lisp
  (use-package tab-bar
    :ensure nil   ; built-in
    :init (tab-bar-mode 1)
