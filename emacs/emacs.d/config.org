...
** Windmove
;; C-w restaurado a kill-region (cortar).
;; Splits y cierre quedan vainilla: C-x 2, C-x 3, C-x 0, C-x 1.
;; M-hjkl mueve el foco entre ventanas.
;; M-HJKL intercambia la ventana con su vecina.
#+begin_src emacs-lisp
